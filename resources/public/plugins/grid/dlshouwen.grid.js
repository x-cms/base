        ...
        init: function (options, name) {
            ...
            var gridObject = {
                            ...
                            if (gridReflectionObj.option.loadAll) {
                                ...
                                $.ajax({
                                    ...
                                    error: function (XMLHttpRequest, textStatus, errorThrown) {
                                        gridReflectionObj.hideProcessBar(function () {
                                            $.fn.dtGrid.tools.toast($.fn.dtGrid.lang[gridReflectionObj.option.lang].errors.ajaxLoadError, 'error', 5000);
                                            //构建表格、工具条
                                            gridReflectionObj.constructGrid();
                                            gridReflectionObj.constructGridPageBar();
                                        });
                ...
                constructGrid: function () {
                    ...
                    //构件表头
                    var gridContent = '';
                    gridContent += '<table class="grid ' + gridReflectionObj.option.tableClass + '" id="grid_' + gridReflectionObj.option.id + '" style="' + gridReflectionObj.option.tableStyle + '">';
                    if (gridReflectionObj.option.showHeader != false) {
                        ...
                        if (gridReflectionObj.option.check) {
                            if (gridReflectionObj.option.checkWidth != null) {
                                gridContent += '	<th class="check-column" width="' + gridReflectionObj.option.checkWidth + '"><input type="checkbox" id="grid_' + gridReflectionObj.option.id + '_check" value="check"></th>';
                            } else {
                                gridContent += '	<th class="check-column"><input type="checkbox" id="grid_' + gridReflectionObj.option.id + '_check" value="check"></th>';
                            }
                        }
                        for (var i = 0; i < columns.length; i++) {
                            if (columns[i].width != null) {
                                gridContent += '	<th width="' + columns[i].width + '" columnNo="' + i + '" columnId="' + columns[i].id + '" class="grid-header ' + gridReflectionObj.getColumnClassForHide(columns[i]) + ' ' + columns[i].headerClass + ' can-sort" style="' + columns[i].headerStyle + '">';
                            } else {
                                gridContent += '	<th columnNo="' + i + '" columnId="' + columns[i].id + '" class="grid-header ' + gridReflectionObj.getColumnClassForHide(columns[i]) + ' ' + columns[i].headerClass + ' can-sort" style="' + columns[i].headerStyle + '">';
                            }
                            if (gridReflectionObj.sortParameter && gridReflectionObj.sortParameter.columnId && gridReflectionObj.sortParameter.columnId == columns[i].id) {
                                if (gridReflectionObj.sortParameter.sortType == '1') {
                                    gridContent += '<span class="grid-sort">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].sortColumn.asc + '</span>';
                                } else if (gridReflectionObj.exhibitDatas[i]['child'].length == 0 && j == 0) {
                                    gridContent += '<a href="javascript:;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.noChild + '</a> '
                                }
                                if (gridReflectionObj.sortParameter.sortType == '2') {
                                    gridContent += '<span class="grid-sort grid-sort-desc">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].sortColumn.desc + '</span>';
                                } else if (gridReflectionObj.exhibitDatas[i]['child'].length == 0 && j == 0) {
                                    gridContent += '<a href="javascript:;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.noChild + '</a> '
                                }
                            }
                    ...
                    if (gridReflectionObj.exhibitDatas != null) {
                        ...
                        for (var i = 0; i < gridReflectionObj.exhibitDatas.length; i++) {
                            gridContent += '<tr class="grid-row " dataNo="' + gridReflectionObj.exhibitDatas[i]['id'] + '">';
                            if (gridReflectionObj.option.extraWidth != null) {
                                gridContent += '<td class="extra-column extra-column-event ' + extraColumnClass + '" width="' + gridReflectionObj.option.extraWidth + '" dataNo="' + gridReflectionObj.exhibitDatas[i]['id'] + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].extraColumn.open + '</td>';
                            } else {
                                gridContent += '<td class="extra-column extra-column-event ' + extraColumnClass + '" dataNo="' + gridReflectionObj.exhibitDatas[i]['id'] + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].extraColumn.open + '</td>';
                            }
                            if (gridReflectionObj.option.check) {
                                if (gridReflectionObj.option.checkWidth != null) {
                                    gridContent += '<td class="check-column text-center" width="' + gridReflectionObj.option.checkWidth + '"><input type="checkbox" dataNo="' + gridReflectionObj.exhibitDatas[i]['id'] + '" id="grid_' + gridReflectionObj.option.id + '_check_' + gridReflectionObj.exhibitDatas[i]['id'] + '" class="grid-check" value="' + gridReflectionObj.exhibitDatas[i]['id'] + '"></td>';
                                } else {
                                    gridContent += '<td class="check-column text-center"><input type="checkbox" dataNo="' + gridReflectionObj.exhibitDatas[i]['id'] + '" id="grid_' + gridReflectionObj.option.id + '_check_' + gridReflectionObj.exhibitDatas[i]['id'] + '" class="grid-check" value="' + gridReflectionObj.exhibitDatas[i]['id'] + '"></td>';
                                }
                            }
                            var columns = gridReflectionObj.option.columns;
                            for (var j = 0; j < columns.length; j++) {
                                if (columns[j].width != null) {
                                    gridContent += '<td width="' + columns[j].width + '" dataNo="' + gridReflectionObj.exhibitDatas[i]['id'] + '" columnNo="' + j + '" class="grid-cell text-center ' + gridReflectionObj.getColumnClassForHide(columns[j]) + ' ' + columns[j].columnClass + '" style="' + columns[j].columnStyle + '">';
                                    if (gridReflectionObj.option.isTreeGrid && gridReflectionObj.exhibitDatas[i]['child'].length != 0 && j == 0) {
                                        gridContent += '<a class="extra-tree extra-tree-column" href="javascript:;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.open + '</a> '
                                    }
                                    if (gridReflectionObj.exhibitDatas[i]['child'].length == 0 && j == 0) {
                                        gridContent += '<a class="extra-tree extra-tree-column" href="javascript:;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.noChild + '</a> '
                                    }
                                } else {
                                    gridContent += '<td dataNo="' + gridReflectionObj.exhibitDatas[i]['id'] + '" columnNo="' + j + '" class="grid-cell text-center ' + gridReflectionObj.getColumnClassForHide(columns[j]) + ' ' + columns[j].columnClass + '" style="' + columns[j].columnStyle + '">';
                                    if (gridReflectionObj.option.isTreeGrid && gridReflectionObj.exhibitDatas[i]['child'].length != 0 && j == 0) {
                                        gridContent += '<a class="extra-tree extra-tree-column" href="javascript:;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.open + '</a> '
                                    }
                                    if (gridReflectionObj.exhibitDatas[i]['child'].length == 0 && j == 0) {
                                        gridContent += '<a  class="extra-tree-column" href="javascript:;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.noChild + '</a> '
                                    }
                                }
                            ...
                            gridContent += '</tr>';
                            gridContent += '<tr id="grid_' + gridReflectionObj.option.id + '_extra_columns_' + gridReflectionObj.exhibitDatas[i]['id'] + '" class="grid-extra-columns hidden">';
                            gridContent += '<td dataNo="' + gridReflectionObj.exhibitDatas[i]['id'] + '" colspan="' + (columns.length + 1 + (gridReflectionObj.option.check ? 1 : 0)) + '">';
                            for (var j = 0; j < columns.length; j++) {
                                if (columns[j].extra == false) {
                                    continue;
                                }
                                gridContent += '<p dataNo="' + gridReflectionObj.exhibitDatas[i]['id'] + '" columnNo="' + j + '" class="grid-cell ' + gridReflectionObj.getExtraColumnClassForHide(columns[j]) + '">';
                            ...
                            if (gridReflectionObj.option.isTreeGrid) {
                                for (var k = 0; k < gridReflectionObj.exhibitDatas[i]['child'].length; k++) {
                                    gridContent += '<tr class="grid-row hidden" dataNo="' + gridReflectionObj.exhibitDatas[i]['child'][k]['id'] + '" data-parent-id="' + gridReflectionObj.exhibitDatas[i]['id'] + '">';
                                    if (gridReflectionObj.option.extraWidth != null) {
                                        gridContent += '<td class="extra-column extra-column-event ' + extraColumnClass + '" width="' + gridReflectionObj.option.extraWidth + '" dataNo="' + gridReflectionObj.exhibitDatas[i]['child'][k]['id'] + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].extraColumn.open + '</td>';
                                    } else {
                                        gridContent += '<td class="extra-column extra-column-event ' + extraColumnClass + '" dataNo="' + gridReflectionObj.exhibitDatas[i]['child'][k]['id'] + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].extraColumn.open + '</td>';
                                    }
                                    if (gridReflectionObj.option.check) {
                                        if (gridReflectionObj.option.checkWidth !== null) {
                                            gridContent += '<td class="check-column text-center" width="' + gridReflectionObj.option.checkWidth + '"><input type="checkbox" dataNo="' + gridReflectionObj.exhibitDatas[i]['child'][k]['id'] + '" id="grid_' + gridReflectionObj.option.id + '_check_' + k + '" class="grid-check" value="' + k + '"></td>';
                                        } else {
                                            gridContent += '<td class="check-column text-center"><input type="checkbox" dataNo="' + gridReflectionObj.exhibitDatas[i]['child'][k]['id'] + '" id="grid_' + gridReflectionObj.option.id + '_check_' + k + '" class="grid-check" value="' + k + '"></td>';
                                        }
                                    }
                                    for (var l = 0; l < columns.length; l++) {
                                        if (columns[l].width != null) {
                                            gridContent += '<td width="' + columns[l].width + '" dataNo="' + gridReflectionObj.exhibitDatas[i]['child'][k]['id'] + '" columnNo="' + (l + 1) + '" class="grid-cell cell-' + l + ' text-center ' + gridReflectionObj.getColumnClassForHide(columns[l]) + ' ' + columns[l].columnClass + '" style="' + columns[l].columnStyle + '">';
                                            if (gridReflectionObj.exhibitDatas[i]['child'][k]['child'].length != 0 && l == 0) {
                                                gridContent += '<a class="extra-tree extra-tree-column" href="javascript:;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.open + '</a>          '
                                            }
                                            if (gridReflectionObj.exhibitDatas[i]['child'][k]['child'].length == 0 && l == 0) {
                                                gridContent += '<a class="extra-tree extra-tree-column" href="javascript:;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.noChild + '</a> '
                                            ...
                                            gridContent += '<td dataNo="' + gridReflectionObj.exhibitDatas[i]['child'][k]['id'] + '" columnNo="' + l + '" class="grid-cell cell-' + (l + 1) + ' text-center ' + gridReflectionObj.getColumnClassForHide(columns[l]) + ' ' + columns[l].columnClass + '" style="' + columns[l].columnStyle + '">';
                                            if (gridReflectionObj.exhibitDatas[i]['child'][k]['child'].length != 0 && l == 0) {
                                                gridContent += '<a class="extra-tree extra-tree-column" href="javascript:;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.open + '</a>          '
                                            }
                                            if (gridReflectionObj.exhibitDatas[i]['child'][k]['child'].length == 0 && l == 0) {
                                        ...
                                        var value = gridReflectionObj.exhibitDatas[i]['child'][k][columns[l].id];
                                        value = value == null ? '' : value;
                                        if (columns[l].resolution) {
                                            gridContent += columns[l].resolution(value, gridReflectionObj.exhibitDatas[i]['child'][k], columns[l], gridReflectionObj, k, l);
                                        } else {
                                            gridContent += gridReflectionObj.formatContent(columns[l], value);
                                        }
                                        gridContent += '</td>';
                                    }
                                    gridContent += '</tr>';
                                    gridContent += '<tr id="grid_' + gridReflectionObj.option.id + '_extra_columns_' + gridReflectionObj.exhibitDatas[i]['child'][k]['id'] + '" class="grid-extra-columns hidden">';
                                    gridContent += '<td dataNo="' + gridReflectionObj.exhibitDatas[i]['child'][k]['id'] + '" colspan="' + (columns.length + 1 + (gridReflectionObj.option.check ? 1 : 0)) + '">';
                                    for (var m = 0; m < columns.length; m++) {
                                        if (columns[m].extra == false) {
                                            continue;
                                        }
                                        gridContent += '<p dataNo="' + gridReflectionObj.exhibitDatas[i]['child'][k]['id'] + '" columnNo="' + m + '" class="grid-cell ' + gridReflectionObj.getExtraColumnClassForHide(columns[m]) + '">';
                                        gridContent += '' + columns[m].title + ' : ';
                                        var value = gridReflectionObj.exhibitDatas[i]['child'][k][columns[m].id];
                                        value = value == null ? '' : value;
                                        if (columns[m].resolution) {
                                            gridContent += columns[m].resolution(value, gridReflectionObj.exhibitDatas[i]['child'][k], columns[m], gridReflectionObj, k, m);
                                        } else {
                                            gridContent += gridReflectionObj.formatContent(columns[m], value);
                                        }
                                        gridContent += '</p>';
                                    }
                                    gridContent += '</td>';
                    ...
                    gridContent += '</tbody>';
                    gridContent += '</table>';
                    $('#grid_' + gridReflectionObj.option.id).remove();
                    ...
                    /**
                     ...
                     if(gridReflectionObj.option.onHeaderDblClick){
						$('#grid_'+gridId+' .grid-header').dblclick(function(e){
                    ...
                    $('#grid_' + gridId + ' .extra-column-event').click(function (e) {
                        ...
                        if ($('#grid_' + gridId + '_extra_columns_' + dataNo).hasClass('hidden')) {
                            $('#grid_' + gridId + '_extra_columns_' + dataNo).removeClass('hidden');
                            $(this).html($.fn.dtGrid.lang[gridReflectionObj.option.lang].extraColumn.close);
                            //绑定扩展行展开方法
                            if (gridReflectionObj.option.onExtraOpen) {
                                var row = $('#grid_' + gridId + ' tr[dataNo="' + dataNo + '"]');
                                gridReflectionObj.bindExtraEvent(gridReflectionObj.option.onExtraOpen, row, e);
                            }
                        } else {
                            $('#grid_' + gridId + '_extra_columns_' + dataNo).addClass('hidden');
                            $(this).html($.fn.dtGrid.lang[gridReflectionObj.option.lang].extraColumn.open);
                            //绑定扩展行关闭方法
                    ...
                    //绑定下级数据显隐方法
                    $('#grid_' + gridId + ' .extra-tree').click(function (e) {
                        ...
                        if ($(this).parents('.grid-row').nextAll().filter("[data-parent-id='" + id + "']").hasClass('hidden')) {
                            ...
                            $(this).html($.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.close);
                        } else {
                            $(this).parents('.grid-row').nextAll().filter("[data-parent-id='" + id + "']").addClass('hidden');
                            $(this).html($.fn.dtGrid.lang[gridReflectionObj.option.lang].treeColumn.open);
                        }
                    });
                    //绑定排序方法
                ...
                bindCellEvent: function (func, cellObject, e) {
                    ...
                    var row = $('#grid_' + gridId + ' tr[dataNo="' + dataNo + '"]');
                    //获取扩展行jQuery对象
                    var extraCell = $('#grid_' + gridId + ' .grid-extra-columns>td[dataNo="' + dataNo + '"]');
                ...
                bindHeaderEvent: function (func, headerObject, e) {
                    ...
                    //获取当前行jQuery对象
                    var headerRow = $('#grid_' + gridId + ' tr.grid-headers');
                ...
                constructGridPageBar: function () {
                    ...
                    var gridReflectionObj = this;
                    //清空工具条
                    $('#' + gridReflectionObj.option.toolbarContainer + ' .grid-pager').html('');
                    //获取当前页、每页条数、总页数
                    ...
                    if (gridReflectionObj.exhibitDatas == null || gridReflectionObj.exhibitDatas.length <= 0) {
                        ...
                        gridStatus.innerHTML = $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.nothing;
                    } else {
                        gridStatus.className = 'grid-pager-status text-primary';
                        var info = $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.info;
                        info = $.fn.dtGrid.tools.replaceAll(info, '{startRecord}', gridReflectionObj.pager.startRecord);
                        info = $.fn.dtGrid.tools.replaceAll(info, '{nowPage}', gridReflectionObj.pager.nowPage);
                        info = $.fn.dtGrid.tools.replaceAll(info, '{recordCount}', gridReflectionObj.pager.recordCount);
                        info = $.fn.dtGrid.tools.replaceAll(info, '{pageCount}', gridReflectionObj.pager.pageCount);
                        //设置每页数量的DOM对象
                        var pageSizeElement = '';
                        var pageSize = gridReflectionObj.pager.pageSize;
                        //数组类型
                        if (typeof gridReflectionObj.option.pageSizeLimit == 'object') {
                            pageSizeElement += '<select id="grid_change_page_size_' + gridReflectionObj.option.id + '" name="grid_change_page_size_' + gridReflectionObj.option.id + '" class="form-control change-page-size">';
                            //整合可用页码
                            ...
                            //如果是数值类型则为文本框
                            pageSizeElement += '<input id="grid_change_page_size_' + gridReflectionObj.option.id + '" name="grid_change_page_size_' + gridReflectionObj.option.id + '" type="text" class="form-control change-page-size" value="' + gridReflectionObj.pager.pageSize + '" />';
                            info = $.fn.dtGrid.tools.replaceAll(info, '{pageSize}', pageSizeElement);
                        } else {
                    ...
                    $('#' + gridReflectionObj.option.toolbarContainer + ' .grid-pager').append(operations);
                    $('#' + gridReflectionObj.option.toolbarContainer + ' .grid-pager').append(gridStatus);
                    //绑定修改每页显示条数的事件
                    $('#grid_change_page_size_' + gridReflectionObj.option.id).change(function () {
                        var changePageSize = parseFloat(this.value);
                        if (isNaN(changePageSize)) {
                            $.fn.dtGrid.tools.toast($.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.errors.notANumber, 'warning', 3000);
                            $('#grid_change_page_size_' + gridReflectionObj.option.id).val(gridReflectionObj.pager.pageSize);
                            return;
                        }
                        if (typeof gridReflectionObj.option.pageSizeLimit == 'number') {
                            if (changePageSize > gridReflectionObj.option.pageSizeLimit) {
                                $.fn.dtGrid.tools.toast($.fn.dtGrid.tools.replaceAll($.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.errors.maxPageSize, '{pageSizeLimit}', gridReflectionObj.option.pageSizeLimit), 'warning', 3000);
                                $('#grid_change_page_size_' + gridReflectionObj.option.id).val(gridReflectionObj.pager.pageSize);
                                return;
                            }
                        }
                    ...
                    if (gridReflectionObj.exhibitDatas != null && gridReflectionObj.exhibitDatas.length > 0) {
                        ...
                        goFirstBtn.id = 'grid_' + gridReflectionObj.option.id + '_page_first';
                        goFirstBtn.title = $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.firstPageTitle;
                        if (nowPage <= 1) {
                            goFirstBtn.className = 'disabled';
                            goFirstBtn.title = $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.alreadyFirstPage;
                        }
                        goFirstBtn.innerHTML = '<a href="javascript:void(0);">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.firstPage + '</a>';
                        $('#' + gridReflectionObj.option.id + '_dlshouwenGridOperations').append(goFirstBtn);
                        $('#grid_' + gridReflectionObj.option.id + '_page_first').click(function () {
                            gridReflectionObj.loadByPage('first');
                        });
                        //上一页按钮
                        var goPrevBtn = document.createElement('li');
                        goPrevBtn.id = 'grid_' + gridReflectionObj.option.id + '_page_prev';
                        goPrevBtn.title = $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.prevPageTitle;
                        if (nowPage <= 1) {
                            goPrevBtn.className = 'disabled';
                            goPrevBtn.title = $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.alreadyFirstPage;
                        }
                        goPrevBtn.innerHTML = '<a href="javascript:void(0);">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.prevPage + '</a>';
                        $('#' + gridReflectionObj.option.id + '_dlshouwenGridOperations').append(goPrevBtn);
                        $('#grid_' + gridReflectionObj.option.id + '_page_prev').click(function () {
                        ...
                        if (pageCount <= 5) {
                            for (var i = 1; i <= pageCount; i++) {
                                ...
                                goPageBtn.id = 'grid_' + gridReflectionObj.option.id + '_page_' + i;
                                goPageBtn.setAttribute('page', i);
                                goPageBtn.title = $.fn.dtGrid.tools.replaceAll($.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.nowPageTitle, '{nowPage}', i);
                                goPageBtn.className = i == nowPage ? 'active' : '';
                                goPageBtn.innerHTML = '<a href="javascript:void(0);">' + $.fn.dtGrid.tools.replaceAll($.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.nowPage, '{nowPage}', i) + '</a>';
                                $('#' + gridReflectionObj.option.id + '_dlshouwenGridOperations').append(goPageBtn);
                                if (i != nowPage) {
                                    $('#grid_' + gridReflectionObj.option.id + '_page_' + i).click(function () {
                        ...
                        goNextBtn.id = 'grid_' + gridReflectionObj.option.id + '_page_next';
                        goNextBtn.title = $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.nextPageTitle;
                        if (nowPage >= pageCount) {
                            goNextBtn.className = 'disabled';
                            goNextBtn.title = $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.alreadyLastPage;
                        }
                        goNextBtn.innerHTML = '<a href="javascript:void(0);">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.nextPage + '</a>';
                        $('#' + gridReflectionObj.option.id + '_dlshouwenGridOperations').append(goNextBtn);
                        $('#grid_' + gridReflectionObj.option.id + '_page_next').click(function () {
                            gridReflectionObj.loadByPage('next');
                        });
                        //最后一页按钮
                        var goLastBtn = document.createElement('li');
                        goLastBtn.id = 'grid_' + gridReflectionObj.option.id + '_page_last';
                        goLastBtn.title = $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.lastPageTitle;
                        if (nowPage >= pageCount) {
                            goLastBtn.className = 'disabled';
                            goLastBtn.title = $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.alreadyLastPage;
                        }
                        goLastBtn.innerHTML = '<a href="javascript:void(0);">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].pageInfo.lastPage + '</a>';
                        $('#' + gridReflectionObj.option.id + '_dlshouwenGridOperations').append(goLastBtn);
                        $('#grid_' + gridReflectionObj.option.id + '_page_last').click(function () {
                            gridReflectionObj.loadByPage('last');
                        });
                    }
                    //清除浮动
                    $('#' + gridReflectionObj.option.toolbarContainer + ' .grid-pager').append('<div class="clearfix"></div>');
                ...
                toolbar: function (type) {
                    ...
                    //定义工具条内容
                    var toolbars = {
                        refresh: '<li title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.refreshTitle + '"><a href="javascript:void(0);" id="refreshGrid_replaceId">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.refresh + '</a></li>',
                        fastQuery: '<li title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.fastQueryTitle + '"><a href="javascript:void(0);" id="fastQuery_replaceId">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.fastQuery + '</a></li>',
                        advanceQuery: '<li title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.advanceQueryTitle + '"><a href="javascript:void(0);" id="advanceQuery_replaceId">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.advanceQuery + '</a></li>',
                        exportExcel: '<li title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.exportExcelTitle + '"><a href="javascript:void(0);" id="exportExcelGrid_replaceId">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.exportExcel + '</a></li>',
                        exportCsv: '<li title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.exportCsvTitle + '"><a href="javascript:void(0);" id="exportCsvGrid_replaceId">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.exportCsv + '</a></li>',
                        exportPdf: '<li title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.exportPdfTitle + '"><a href="javascript:void(0);" id="exportPdfGrid_replaceId">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.exportPdf + '</a></li>',
                        exportTxt: '<li title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.exportTxtTitle + '"><a href="javascript:void(0);" id="exportTxtGrid_replaceId">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.exportTxt + '</a></li>',
                        print: '<li title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.printTitle + '"><a href="javascript:void(0);" id="printGrid_replaceId">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].toolbar.print + '</a></li>'
                    };
                ...
                constructGridToolBar: function () {
                    ...
                    var gridReflectionObj = this;
                    //清空工具条
                    $('#' + gridReflectionObj.option.toolbarContainer).html('<span class="pagination pagination-sm grid-tools"></span><span class="grid-pager"></span>');
                    //如果为空则不做任何操作
                    ...
                    for (var i = 0; i < tools.split('|').length; i++) {
                        ...
                        //处理刷新
                        if (tool == 'refresh') {
                            var content = $.fn.dtGrid.tools.replaceAll(gridReflectionObj.toolbar('refresh'), 'replaceId', gridReflectionObj.option.id);
                            $('#' + gridReflectionObj.option.toolbarContainer + ' .grid-tools').append(content);
                            //绑定方法
                        ...
                        //处理快速查询
                        if (tool == 'fastQuery') {
                            var content = $.fn.dtGrid.tools.replaceAll(gridReflectionObj.toolbar('fastQuery'), 'replaceId', gridReflectionObj.option.id);
                            $('#' + gridReflectionObj.option.toolbarContainer + ' .grid-tools').append(content);
                            //绑定方法
                        ...
                        if (tool == 'advanceQuery') {
                            var content = $.fn.dtGrid.tools.replaceAll(gridReflectionObj.toolbar('advanceQuery'), 'replaceId', gridReflectionObj.option.id);
                            $('#' + gridReflectionObj.option.toolbarContainer + ' .grid-tools').append(content);
                            //绑定方法
                        ...
                        if (tool.indexOf('export') != -1) {
                            ...
                            for (var j = 0; j < tool.split(',').length; j++) {
                                ...
                                if (exportTool == 'excel') {
                                    content += $.fn.dtGrid.tools.replaceAll(gridReflectionObj.toolbar('exportExcel'), 'replaceId', gridReflectionObj.option.id);
                                }
                                if (exportTool == 'csv') {
                                    content += $.fn.dtGrid.tools.replaceAll(gridReflectionObj.toolbar('exportCsv'), 'replaceId', gridReflectionObj.option.id);
                                }
                                if (exportTool == 'pdf') {
                                    content += $.fn.dtGrid.tools.replaceAll(gridReflectionObj.toolbar('exportPdf'), 'replaceId', gridReflectionObj.option.id);
                                }
                                if (exportTool == 'txt') {
                                    content += $.fn.dtGrid.tools.replaceAll(gridReflectionObj.toolbar('exportTxt'), 'replaceId', gridReflectionObj.option.id);
                                }
                            }
                            $('#' + gridReflectionObj.option.toolbarContainer + ' .grid-tools').append(content);
                            //绑定方法
                        ...
                        //处理打印
                        if (tool == 'print') {
                            var content = $.fn.dtGrid.tools.replaceAll(gridReflectionObj.toolbar('print'), 'replaceId', gridReflectionObj.option.id);
                            $('#' + gridReflectionObj.option.toolbarContainer + ' .grid-tools').append(content);
                            //绑定方法
                ...
                showProcessBar: function () {
                    ...
                    $('#grid_process_bar_top_' + gridReflectionObj.option.id).remove();
                    $('#grid_process_bar_bottom_' + gridReflectionObj.option.id).remove();
                    gridReflectionObj.processWidth = 0;
                    gridReflectionObj.processBarThread = null;
                    var content = '';
                    content += '<div class="grid-process-bar-top bg-primary" id="grid_process_bar_top_' + gridReflectionObj.option.id + '"></div>';
                    content += '<div class="grid-process-bar-bottom bg-primary" id="grid_process_bar_bottom_' + gridReflectionObj.option.id + '"></div>';
                    ...
                    $('#grid_process_bar_top_' + gridReflectionObj.option.id).animate({width: gridReflectionObj.processWidth + '%'}, 200);
                    $('#grid_process_bar_bottom_' + gridReflectionObj.option.id).animate({width: gridReflectionObj.processWidth + '%'}, 200);
                ...
                hideProcessBar: function (callback) {
                    ...
                    clearInterval(gridReflectionObj.processBarThread);
                    var gridReflectionObj = this;
                    $('#grid_process_bar_top_' + gridReflectionObj.option.id).animate({width: '100%'}, 100, function () {
                        $('#grid_process_bar_top_' + gridReflectionObj.option.id).remove();
                        callback();
                    });
                    $('#grid_process_bar_bottom_' + gridReflectionObj.option.id).animate({width: '100%'}, 100, function () {
                        $('#grid_process_bar_bottom_' + gridReflectionObj.option.id).remove();
                    });
                },
                //格式化内容
                ...
                fastQuery: function () {
                    ...
                    var content = '';
                    content += $.fn.dtGrid.tools.getWindowStart('fast_query_' + gridReflectionObj.option.id, $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.title);
                        ...
                        if (column.fastQuery == true) {
                            ...
                            if (column.fastQueryType == 'range') {
                                ...
                                if (column.type == 'date') {
                                    ...
                                    content += '	<input type="text" class="form-control" id="ge_' + column.id + '" name="ge_' + column.id + '" format="' + column.format + '" placeholder="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.selectStart + column.title + '" onclick="WdatePicker({dateFmt:\'' + $.fn.dtGrid.tools.replaceAll(column.format, 'h', 'H') + '\'});" />';
                                    content += '	<div class="input-group-addon"><i class="fa fa-calendar"></i></div>';
                                    content += '</div>';
                                } else {
                                    content += '<input type="text" class="form-control" id="ge_' + column.id + '" name="ge_' + column.id + '" placeholder="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.inputStart + column.title + '" />';
                                }
                                content += '</div>';
                                content += '<div class="col-sm-4">';
                                if (column.type == 'date') {
                                    content += '<div class="input-group">';
                                    content += '	<input type="text" class="form-control" id="le_' + column.id + '" name="le_' + column.id + '" format="' + column.format + '" placeholder="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.selectEnd + column.title + '" onclick="WdatePicker({dateFmt:\'' + $.fn.dtGrid.tools.replaceAll(column.format, 'h', 'H') + '\'});" />';
                                    content += '	<div class="input-group-addon"><i class="fa fa-calendar"></i></div>';
                                    content += '</div>';
                                } else {
                                    content += '<input type="text" class="form-control" id="le_' + column.id + '" name="le_' + column.id + '" placeholder="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.inputEnd + column.title + '" />';
                                }
                                content += '</div>';
                                ...
                                content += '		<option value="">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.codeTableSelectAll + '</option>';
                                ...
                                if (column.type == 'date') {
                                    content += '<div class="input-group">';
                                    var hoderName = $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.selectStart;
                                    if (column.fastQueryType == 'lt' || column.fastQueryType == 'le') {
                                        hoderName = $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.selectEnd;
                                    }
                                    ...
                                    content += '<input type="text" class="form-control" id="' + column.fastQueryType + '_' + column.id + '" name="' + column.fastQueryType + '_' + column.id + '" placeholder="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.input + column.title + '" />';
                                }
                                content += '</div>';
                            }
                            content += '</div>';
                    ...
                    content += '</form>';
                    var buttons = '';
                    buttons += '<button type="button" class="btn btn-warning" id="resetFastQuery_' + gridReflectionObj.option.id + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.buttons.reset + '</button>';
                    buttons += '<button type="button" class="btn btn-primary" id="doFastQuery_' + gridReflectionObj.option.id + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].fastQuery.buttons.query + '</button>';
                    content += $.fn.dtGrid.tools.getWindowEnd($.fn.dtGrid.lang[gridReflectionObj.option.lang].buttons.close, buttons);
                    $('body').append(content);
                    //绑定方法
                ...
                advanceQuery: function () {
                    ...
                    //加载查询内容
                    var content = '';
                    content += $.fn.dtGrid.tools.getWindowStart('advance_query_' + gridReflectionObj.option.id, $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.title);
                    content += '<div class="modal-body advance-query">';
                    content += '	<ul class="nav nav-tabs" role="tablist">';
//					content += '		<li><a href="#advance_query_plan_'+gridReflectionObj.option.id+'" role="tab" data-toggle="tab">'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.title+'</a></li>';
                    content += '		<li class="active"><a href="#advance_query_condition_' + gridReflectionObj.option.id + '" role="tab" data-toggle="tab">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.title + '</a></li>';
                    content += '		<li><a href="#advance_query_sort_' + gridReflectionObj.option.id + '" role="tab" data-toggle="tab">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.title + '</a></li>';
                    content += '	</ul>';
...
//					content += '					<div class="form-group">';
//					content += '						<label class="col-sm-3 control-label text-right">'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.advanceQueryName+'</label>';
//					content += '						<div class="col-sm-6">';
//					content += '							<input type="text" class="form-control" id="advanceQueryName_'+gridReflectionObj.option.id+'" name="advanceQueryName_'+gridReflectionObj.option.id+'" placeholder="'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.advanceQueryNamePlaceHoder+'">';
//					content += '						</div>';
//					content += '					</div>';
//					content += '					<div class="form-group">';
//					content += '						<label class="col-sm-3 control-label text-right">'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.remark+'</label>';
//					content += '						<div class="col-sm-6">';
//					content += '							<textarea id="remark_'+gridReflectionObj.option.id+'" name="remark_'+gridReflectionObj.option.id+'" class="form-control" placeholder="'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.remarkPlaceHoder+'"></textarea>';
//					content += '						</div>';
//					content += '					</div>';
//					content += '					<div class="form-group">';
//					content += '						<div class="col-sm-offset-3 col-sm-12">';
//					content += '							<button id="addAdvanceQuery_'+gridReflectionObj.option.id+'" title="'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.buttons.addAdvanceQueryTitle+'" class="btn btn-xs btn-primary">';
//					content += '								'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.buttons.addAdvanceQuery;
//					content += '							</button>';
//					content += '							<button id="editAdvanceQuery_'+gridReflectionObj.option.id+'" title="'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.buttons.editAdvanceQueryTitle+'" class="btn btn-xs btn-primary">';
//					content += '								'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.buttons.editAdvanceQuery;
//					content += '							</button>';
//					content += '							<button id="copyAdvanceQuery_'+gridReflectionObj.option.id+'" title="'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.buttons.copyAdvanceQueryTitle+'" class="btn btn-xs btn-warning">';
//					content += '								'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.buttons.copyAdvanceQuery;
//					content += '							</button>';
//					content += '							<button id="deleteAdvanceQuery_'+gridReflectionObj.option.id+'" title="'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.buttons.deleteAdvanceQueryTitle+'" class="btn btn-xs btn-danger">';
//					content += '								'+$.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.plan.buttons.deleteAdvanceQuery;
//					content += '							</button>';
//					content += '						</div>';
//					content += '					</div>';
//					content += '				</div>';
...
//					content += '		</div>';
                    ...
                    content += '					<button id="insertConditionTr_' + gridReflectionObj.option.id + '" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.buttons.insertTitle + '" class="btn btn-xs btn-primary">';
                    content += '						' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.buttons.insert;
                    content += '					</button>';
                    content += '					<button id="clearConditionTr_' + gridReflectionObj.option.id + '" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.buttons.clearTitle + '" class="btn btn-xs btn-danger">';
                    content += '						' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.buttons.clear;
                    content += '					</button>';
                    content += '				</div>';
                    ...
                    content += '						<tr>';
                    content += '							<th style="width:50px;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.sequence + '</th>';
                    content += '							<th style="width:100px;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.operation + '</th>';
                    content += '							<th style="width:80px;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.leftParentheses + '</th>';
                    content += '							<th style="width:140px;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.field + '</th>';
                    content += '							<th style="width:120px;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.condition + '</th>';
                    content += '							<th>' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.value + '</th>';
                    content += '							<th style="width:80px;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.rightParentheses + '</th>';
                    content += '							<th style="width:90px;">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.logic + '</th>';
                    content += '						</tr>';
                    content += '					</table>';
                    content += '				</div>';
                    ...
                    content += '			<div class="panel panel-default">';
                    content += '				<div class="form-horizontal text-right advance-query-buttons">';
                    content += '					<button id="insertSortTr_' + gridReflectionObj.option.id + '" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.buttons.insertTitle + '" class="btn btn-xs btn-primary">';
                    content += '						' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.buttons.insert;
                    content += '					</button>';
                    content += '					<button id="clearSortTr_' + gridReflectionObj.option.id + '" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.buttons.clearTitle + '" class="btn btn-xs btn-danger">';
                    content += '						' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.buttons.clear;
                    content += '					</button>';
                    content += '				</div>';
                    content += '				<div class="advance-query-table-container">';
                    ...
                    content += '						<tr>';
                    content += '							<th>' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.table.sequence + '</th>';
                    content += '							<th>' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.table.operation + '</th>';
                    content += '							<th>' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.table.field + '</th>';
                    content += '							<th>' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.table.logic + '</th>';
                    content += '						</tr>';
                    content += '					</table>';
                    content += '				</div>';
                    content += '				<div class="clearfix"></div>';
                    ...
                    buttons += '	' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.buttons.query;
                    buttons += '</button>';
                    content += $.fn.dtGrid.tools.getWindowEnd($.fn.dtGrid.lang[gridReflectionObj.option.lang].buttons.close, buttons);
                    $('body').append(content);
//					//新增高级查询方案
...
//					});
                ...
                doAdvanceQuery: function () {
                    ...
                    $('#conditionTable_' + gridReflectionObj.option.id + ' tr[id*=tr_' + gridReflectionObj.option.id + '_]').each(function () {
                        ...
                        if (field == '') {
                            $.fn.dtGrid.tools.toast($.fn.dtGrid.tools.replaceAll($.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.errors.fieldMustSelect, '{sequence}', seq), 'warning', 3000);
                            pass = false;
                            return false;
                        }
                        if (condition == '') {
                            $.fn.dtGrid.tools.toast($.fn.dtGrid.tools.replaceAll($.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.errors.conditionMustSelect, '{sequence}', seq), 'warning', 3000);
                            pass = false;
                            return false;
                        }
                    ...
                    $('#sortTable_' + gridReflectionObj.option.id + ' tr[id*=tr_' + gridReflectionObj.option.id + '_]').each(function () {
                        ...
                        if (sortField == '') {
                            $.fn.dtGrid.tools.toast($.fn.dtGrid.tools.replaceAll($.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.errors.fieldMustSelect, '{sequence}', seq), 'warning', 3000);
                            pass = false;
                            return false;
                        }
                        if (sortLogic == '') {
                            $.fn.dtGrid.tools.toast($.fn.dtGrid.tools.replaceAll($.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.errors.logicMustSelect, '{sequence}', seq), 'warning', 3000);
                            pass = false;
                            return false;
                        }
                    ...
                    for (var i = 0; i < originalDatas.length; i++) {
                        ...
                        if (advanceQueryParameter.advanceQueryConditions && advanceQueryParameter.advanceQueryConditions.length > 0) {
                            ...
                            try {
                                ...
                                $.fn.dtGrid.tools.toast($.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.errors.conditionError, 'error', 3000);
                ...
                insertConditionTr: function () {
                    ...
                    content += '	<td>';
                    content += '		<button type="button" id="moveUpConditionTr_' + gridReflectionObj.option.id + '_' + gridReflectionObj.sequenceCondition + '" class="btn btn-primary btn-xs" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.buttons.upTitle + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.buttons.up + '</button>';
                    content += '		<button type="button" id="moveDownConditionTr_' + gridReflectionObj.option.id + '_' + gridReflectionObj.sequenceCondition + '" class="btn btn-primary btn-xs" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.buttons.downTitle + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.buttons.down + '</button>';
                    content += '		<button type="button" id="deleteConditionTr_' + gridReflectionObj.option.id + '_' + gridReflectionObj.sequenceCondition + '" class="btn btn-danger btn-xs" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.buttons.deleteTitle + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.condition.table.buttons['delete'] + '</button>';
                    content += '	</td>';
                    content += '	<td>';
                ...
                fieldChange: function (id) {
                    ...
                    if (column.type == 'date') {
                        var content = '';
                        content += '<div class="input-group">';
                        content += '	<input id="value_' + gridReflectionObj.option.id + '_' + id + '" name="value_' + gridReflectionObj.option.id + '_' + id + '" class="form-control" onclick="WdatePicker({dateFmt:\'' + $.fn.dtGrid.tools.replaceAll(column.format, 'h', 'H') + '\'})" />';
                        content += '	<div class="input-group-addon"><i class="fa fa-calendar"></i></div>';
                        content += '</div>';
                ...
                insertSortTr: function () {
                    ...
                    content += '	<td>';
                    content += '		<button type="button" id="moveUpSortTr_' + gridReflectionObj.option.id + '_' + gridReflectionObj.sequenceSort + '" class="btn btn-primary btn-xs" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.table.buttons.upTitle + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.table.buttons.up + '</button>';
                    content += '		<button type="button" id="moveDownSortTr_' + gridReflectionObj.option.id + '_' + gridReflectionObj.sequenceSort + '" class="btn btn-primary btn-xs" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.table.buttons.downTitle + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.table.buttons.down + '</button>';
                    content += '		<button type="button" id="deleteSortTr_' + gridReflectionObj.option.id + '_' + gridReflectionObj.sequenceSort + '" class="btn btn-danger btn-xs" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.table.buttons.deleteTitle + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.table.buttons['delete'] + '</button>';
                    content += '	</td>';
                    content += '	<td>';
                    ...
                    content += '			<option value=""></option>';
                    content += '			<option value="0">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.logic.asc + '</option>';
                    content += '			<option value="1">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].advanceQuery.sort.logic.desc + '</option>';
                    content += '		</select>';
                    content += '	</td>';
                    content += '</tr>';
                ...
                print: function () {
                    ...
                    if (gridReflectionObj.init.printWindowIsInit) {
                        $('#grid_print_' + gridReflectionObj.option.id + '_modal').modal('show');
                        return;
                    }
                    //放置新的打印选项
                    var content = '';
                    content += $.fn.dtGrid.tools.getWindowStart('grid_print_' + gridReflectionObj.option.id, $.fn.dtGrid.lang[gridReflectionObj.option.lang].print.title);
                    content += '				<table class="table table-bordered table-print">';
                    content += '					<thead>';
                    content += '						<tr>';
                    content += '							<th><input type="checkbox" id="grid_print_check_' + gridReflectionObj.option.id + '" checked="checked" /></th>';
                    content += '							<th>' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].print.table.column + '</th>';
                    content += '							<th>' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].print.table.operation + '</th>';
                    content += '						</tr>';
                    content += '					</thead>';
                    content += '					<tbody>';
                    //遍历列信息
                    for (var i = 0; i < gridReflectionObj.option.columns.length; i++) {
                        ...
                        //获取记录号
                        content += '					<tr id="grid_print_tr_' + gridReflectionObj.option.id + '_' + i + '">';
                        content += '						<td><input type="checkbox" id="grid_print_check_' + gridReflectionObj.option.id + '_' + i + '" checked="checked" value="' + i + '" /></td>';
                        content += '						<td>' + column.title + '</td>';
                        content += '						<td>';
                        content += '							<button type="button" class="btn btn-primary btn-xs" dataId="' + i + '" id="grid_print_up_' + gridReflectionObj.option.id + '_' + i + '" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].print.table.buttons.upTitle + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].print.table.buttons.up + '</button>';
                        content += '							<button type="button" class="btn btn-primary btn-xs" dataId="' + i + '" id="grid_print_down_' + gridReflectionObj.option.id + '_' + i + '" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].print.table.buttons.downTitle + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].print.table.buttons.down + '</button>';
                        content += '						</td>';
                        content += '					</tr>';
                    }
                    content += '					</tbody>';
                    content += '				</table>';
                    var buttons = '';
                    buttons += '<button type="button" class="btn btn-primary" id="grid_print_execute_' + gridReflectionObj.option.id + '">';
                    buttons += '	' + $.fn.dtGrid.lang[gridReflectionObj.option.lang].print.buttons.print;
                    buttons += '</button>';
                    content += $.fn.dtGrid.tools.getWindowEnd($.fn.dtGrid.lang[gridReflectionObj.option.lang].buttons.close, buttons);
                    $('body').append(content);
                    //绑定复选全选反选方法
                    $('#grid_print_check_' + gridReflectionObj.option.id).click(function () {
                        $('input[id*=grid_print_check_' + gridReflectionObj.option.id + '_]').prop('checked', this.checked);
                    });
                    //绑定上移方法
                    $('button[id*=grid_print_up_' + gridReflectionObj.option.id + '_]').click(function () {
                    ...
                    //绑定下移方法
                    $('button[id*=grid_print_down_' + gridReflectionObj.option.id + '_]').click(function () {
                        var dataId = $(this).attr('dataId');
                        var gridId = gridReflectionObj.option.id;
                    ...
                    //绑定打印方法
                    $('#grid_print_execute_' + gridReflectionObj.option.id).click(function () {
                        //画表格
                        var content = '';
                        content += '<table class="grid ' + gridReflectionObj.option.tableClass + '" id="grid_print_' + gridReflectionObj.option.id + '" style="' + gridReflectionObj.option.tableStyle + '">';
                        if (gridReflectionObj.option.showHeader != false) {
                            content += '<thead>';
                            content += '	<tr>';
                            $('input[id*=grid_print_check_' + gridReflectionObj.option.id + '_]:checked').each(function () {
                        ...
                        $('html').append(content);
                        window.print();
                        $('#grid_print_' + gridReflectionObj.option.id).remove();
                        $('body').show();
                        $('#grid_print_' + gridReflectionObj.option.id + '_modal').modal('hide');
                ...
                exportFile: function (exportType) {
                    ...
                    if (gridReflectionObj.init.exportWindowIsInit[exportType]) {
                        //显示导出选项
                        $('#grid_export_' + exportType + '_' + gridReflectionObj.option.id + '_modal').modal('show');
                        return;
                    }
                    //放置新的导出选项
                    var content = '';
                    content += $.fn.dtGrid.tools.getWindowStart('grid_export_' + exportType + '_' + gridReflectionObj.option.id, $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].title);
                    content += '				<div class="form-export modal-body form-horizontal form-export">';
                    content += '					<div class="form-group">';
                    content += '						<label class="col-sm-3 control-label">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].exportType.title + '</label>';
                    content += '						<div class="col-sm-9">';
                    content += '							<div class="checkbox">';
                    content += '								<label><input type="radio" name="grid_export_export_all_data_' + exportType + '_' + gridReflectionObj.option.id + '" value="0" checked="checked" /> ' + $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].exportType.now + '</label>';
                    content += '								<label><input type="radio" name="grid_export_export_all_data_' + exportType + '_' + gridReflectionObj.option.id + '" value="1" /> ' + $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].exportType.all + '</label>';
                    content += '							</div>';
                    content += '						</div>';
                    content += '					</div>';
                    content += '				</div>';
                    ...
                    content += '					<thead>';
                    content += '						<tr>';
                    content += '							<th><input type="checkbox" id="grid_export_check_' + exportType + '_' + gridReflectionObj.option.id + '" checked="checked" /></th>';
                    content += '							<th>' + $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].table.column + '</th>';
                    content += '							<th>' + $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].table.operation + '</th>';
                    content += '						</tr>';
                    content += '					</thead>';
                    content += '					<tbody>';
                    //遍历列信息
                    for (var i = 0; i < gridReflectionObj.option.columns.length; i++) {
                        ...
                        content += '					<tr id="grid_export_tr_' + exportType + '_' + gridReflectionObj.option.id + '_' + i + '">';
                        content += '						<td><input type="checkbox" id="grid_export_check_' + exportType + '_' + gridReflectionObj.option.id + '_' + i + '" checked="checked" value="' + i + '" /></td>';
                        content += '						<td>' + column.title + '</td>';
                        content += '						<td>';
                        content += '							<button type="button" class="btn btn-primary btn-xs" dataId="' + i + '" id="grid_export_up_' + exportType + '_' + gridReflectionObj.option.id + '_' + i + '" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].table.buttons.upTitle + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].table.buttons.up + '</button>';
                        content += '							<button type="button" class="btn btn-primary btn-xs" dataId="' + i + '" id="grid_export_down_' + exportType + '_' + gridReflectionObj.option.id + '_' + i + '" title="' + $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].table.buttons.downTitle + '">' + $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].table.buttons.down + '</button>';
                        content += '						</td>';
                        content += '					</tr>';
                    }
                    content += '					</tbody>';
                    content += '				</table>';
                    var buttons = '';
                    buttons += '<button type="button" class="btn btn-primary" id="grid_export_execute_' + exportType + '_' + gridReflectionObj.option.id + '">';
                    buttons += '	' + $.fn.dtGrid.lang[gridReflectionObj.option.lang]['export'][exportType].buttons['export'];
                    buttons += '</button>';
                    content += $.fn.dtGrid.tools.getWindowEnd($.fn.dtGrid.lang[gridReflectionObj.option.lang].buttons.close, buttons);
                    $('body').append(content);
                    //绑定复选方法
                    $('#grid_export_check_' + exportType + '_' + gridReflectionObj.option.id).click(function () {
                        $('input[id*=grid_export_check_' + exportType + '_' + gridReflectionObj.option.id + '_]').prop('checked', this.checked);
                    });
                    //绑定上移方法
                    $('button[id*=grid_export_up_' + exportType + '_' + gridReflectionObj.option.id + '_]').click(function () {
                        var dataId = $(this).attr('dataId');
                        var gridId = gridReflectionObj.option.id;
                    ...
                    //绑定下移方法
                    $('button[id*=grid_export_down_' + exportType + '_' + gridReflectionObj.option.id + '_]').click(function () {
                        var dataId = $(this).attr('dataId');
                        var gridId = gridReflectionObj.option.id;
                    ...
                    //绑定导出方法
                    $('#grid_export_execute_' + exportType + '_' + gridReflectionObj.option.id).click(function () {
                        //删除原表单
                        $('#grid_export_form_container_' + exportType + '_' + gridReflectionObj.option.id).remove();
                        //将参数传递后台使用伪表单进行导出
                        var exportFormContainer = document.createElement('div');
                        exportFormContainer.id = 'grid_export_form_container_' + exportType + '_' + gridReflectionObj.option.id;
                        exportFormContainer.className = 'hidden';
                        var exportIframe = document.createElement('iframe');
                        exportIframe.name = 'grid_export_iframe_' + exportType + '_' + gridReflectionObj.option.id;
                        exportFormContainer.appendChild(exportIframe);
                        var exportForm = document.createElement('form');
                        exportForm.id = 'grid_export_form_' + exportType + '_' + gridReflectionObj.option.id;
                        exportForm.method = 'post';
                        exportForm.target = 'grid_export_iframe_' + exportType + '_' + gridReflectionObj.option.id;
                        ...
                        gridPager.exportAllData = $('input[name*=grid_export_export_all_data_' + exportType + '_' + gridReflectionObj.option.id + ']:checked').val() == '1' ? true : false;
                        ...
                        $('input[id*=grid_export_check_' + exportType + '_' + gridReflectionObj.option.id + '_]:checked').each(function () {
                        ...
                        $('#grid_export_form_' + exportType + '_' + gridReflectionObj.option.id).submit();
                        $('#grid_export_' + exportType + '_' + gridReflectionObj.option.id + '_modal').modal('hide');
                    });
                    //设置初始化完成
                ...
                getCheckedRecords: function () {
                    ...
                    $('input[id*=grid_' + gridReflectionObj.option.id + '_check_]:checked').each(function () {
